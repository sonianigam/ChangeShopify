...
import { BulkActionsProps } from './components';
...
declare type ResourceListType = (<ItemType>(value: ResourceListProps<ItemType>) => ReactElement) & {
    Item: typeof ResourceItem;
};
export declare const ResourceList: ResourceListType;
export { FilterControl } from './components';
export { FilterControlProps } from './components';
