...
import { ResourceItem as ResourceItem$1 } from '../ResourceItem/ResourceItem.tsx.esnext';
import { Sticky as Sticky$1 } from '../Sticky/Sticky.tsx.esnext';
import { Select as Select$1 } from '../Select/Select.tsx.esnext';
import { useLazyRef as useLazyRef$1 } from '../../utilities/use-lazy-ref.ts.esnext';
import { CheckableButton as CheckableButton$1 } from './components/CheckableButton/CheckableButton.tsx.esnext';
import { BulkActions as BulkActions$1 } from './components/BulkActions/BulkActions.tsx.esnext';
...
const ResourceList = function ResourceList({
  ...
  const paginatedSelectAllAction = () => {
    ...
    const actionText = selectedItems === SELECT_ALL_ITEMS ? i18n.translate('Polaris.Common.undo') : i18n.translate('Polaris.ResourceList.selectAllItems', {
      itemsLength: items.length,
      resourceNamePlural: resourceName.plural
    });
    return {
  ...
  const loadingOverlay = loading ? /*#__PURE__*/React$1.createElement(React$1.Fragment, null, /*#__PURE__*/React$1.createElement("div", {
